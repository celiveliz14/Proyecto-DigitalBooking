...
public interface ReservaService {
    ...
    Optional<ReservaDTO> buscarReserva(Long id) throws ResourceNotFoundException;
    ...
    Optional<List<ReservaDTO>> findAllByProductoId(Long id) throws ResourceNotFoundException;
