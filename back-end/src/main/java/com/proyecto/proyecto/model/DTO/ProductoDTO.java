...
//    @Min(value = 1, message = "Latitud invalida: Tiene que tener maximo 1 caracter")
    private Double latitud;

//    @Min(value = 1, message = "Longitud invalida: Tiene que tener maximo 1 caracter")
    private Double longitud;

//    @Min(value = 1, message = "Altura invalida: Tiene que tener minimo 1 caracter")
