...
const Success = () => {
  ...
  const {succes} = useGlobalStates()

  return (
    <>
    <Header onChange={"home"}/>
    <div className={succes == 'booking' ?'containerSuccess' : 'containerSuccess2'}>
        <div className={succes == 'booking' ? 'cardSuccess' : 'cardSuccess2'}>
          <div className='success'> 
           ...
           {succes == 'booking' ? (
            <>
              ...
              <h2 style={{marginTop:'10px'}}>Su reserva se ha realizado con éxito</h2>
            </>
           ):(
            <h2 style={{marginTop:'10px'}}>Tu propiedad se ha creado con éxito</h2>
           )}
