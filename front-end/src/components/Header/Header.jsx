                ...
                <Link className='flex' to={"/"} style={{textDecoration:"none",cursor:'default'}} >
                  ...
                  {!data.token == '' ? (
                    ...
                    <div className='containerHeader'>
                      {data.roles.length <2 ? <p onClick={() => navigate('/reservas')}className='pAdminHeader' style={{color:'black', padding:"15px"}}>Reservas</p>: ""}
                      {data.roles[1] ? (<p onClick={() => {navigate('/administration')}}className='pAdminHeader' style={{color:'black'}}>Administración</p>) : "" }
                      ...
                      <div style={{display:'flex',flexDirection:'column'}}>
                        <div style={{display:'flex'}}>
                          ...
                          <svg onClick={()=>setData(data.valid=false)} className='svgHeader2'viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" ><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path  d="M195.2 195.2a64 64 0 0 1 90.496 0L512 421.504 738.304 195.2a64 64 0 0 1 90.496 90.496L602.496 512 828.8 738.304a64 64 0 0 1-90.496 90.496L512 602.496 285.696 828.8a64 64 0 0 1-90.496-90.496L421.504 512 195.2 285.696a64 64 0 0 1 0-90.496z"></path></g></svg>
                        </div>
