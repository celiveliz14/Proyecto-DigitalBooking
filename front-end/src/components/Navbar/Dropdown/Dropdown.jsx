...
const Dropdown = ({data,value,admin}) => {
    ...
    let textAdmin2= cat ? `${cat.titulo}`: 'Categoria';
   
  return (
    <div className={admin ? 'sizeDropdownAdmin dropdown' : 'sizeDropdown dropdown'}>
        <div className={admin ? 'sizeDropdownAdmin dropdown-btn' : 'sizeDropdown dropdown-btn'}onClick={handleClick}>
            {
                value == 'city' && (
            ...
            }
            {
              value == 'category' && (
                <div style={{display:'flex',alignItems:'center'}}>
                 <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path fill="none" d="M0 0h24v24H0z"></path> <path d="M22 21H2v-2h1V4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v5h2v10h1v2zm-5-2h2v-8h-6v8h2v-6h2v6zm0-10V5H5v14h6V9h6zM7 11h2v2H7v-2zm0 4h2v2H7v-2zm0-8h2v2H7V7z"></path> </g> </g></svg>
                   {textAdmin2}
                </div>
           )
            }
